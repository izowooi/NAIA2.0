...
# 이제 함수 호출을 통해 스케일링이 적용된 스타일을 반환
try:
    DARK_STYLES = get_legacy_dark_styles()
except:
    # 초기화 시점에서 스케일링 매니저가 아직 준비되지 않은 경우의 fallback
    # 동적 스케일링 적용을 위한 기본값 사용
    try:
        fallback_font_21 = get_scaled_font_size(21)
        fallback_font_20 = get_scaled_font_size(20) 
        fallback_font_22 = get_scaled_font_size(22)
        fallback_font_19 = get_scaled_font_size(19)
        fallback_font_18 = get_scaled_font_size(18)
    except:
        # 최종 fallback - 하드코딩된 값
        fallback_font_21 = 21
        fallback_font_20 = 20
